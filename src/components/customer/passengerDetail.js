          ...
          <View>
            ...
            <View style={{ flexDirection: 'row', paddingBottom: 10 }}>
              ...
              <View style={{ flexDirection: 'column', justifyContent: 'center', width: Dimensions.get('window').width - 100, alignItems: 'center' }}>
                <Text style={{ alignSelf: 'center', fontFamily:'Poppins-Bold', fontSize: 25, color: '#000000' }}> Add Passenger Detail </Text>
              </View>
            </View>
            {/* header view ends */}
            {/* Input view starts */}
            <View style={{ flex: 1, justifyContent: 'space-evenly' }}>
              <CustomTextInput
                style={{ fontSize: 20, color: '#000000', fontFamily:'Poppins-Bold', }}
              ...
              <View style={{ width: Dimensions.get('window').width, paddingVertical: 15, paddingHorizontal: 15 }}>
                <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                  <Text style={{ fontSize: 20, fontFamily:'Poppins-Bold', color: '#000000' }}>Seat - 51</Text>
                  <Text style={{ fontSize: 20, fontFamily:'Poppins-Bold', color: '#000000' }}>Coach - S9</Text>
                </View>
                <Text style={{ fontSize: 20, fontFamily:'Poppins-Bold', color: '#000000' }}>Station - Kanpur</Text>
                <Text style={{ fontSize: 20, fontFamily:'Poppins-Bold', color: '#000000' }}>Expected Date & Time of Delivery - 07/09/2019  08:35 PM</Text>
              </View>
              <CustomTextInput
                style={{ fontSize: 20, color: '#000000', fontFamily:'Poppins-Bold', }}
              ...
              />
              <View style={{ width: Dimensions.get('window').width, paddingVertical: 15, paddingHorizontal: 15 }}>
                <Text style={{ fontSize: 20, fontFamily:'Poppins-Bold', color: '#000000' }}>Contact No - {ConstantValues.customerPhoneNo}</Text>
              </View>
